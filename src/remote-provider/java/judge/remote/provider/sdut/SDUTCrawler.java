...
public class SDUTCrawler extends SimpleCrawler {
    ...
    protected void populateProblemInfo(RawProblemInfo info, String problemId, String html) {
        ...
        info.memoryLimit = (Integer.parseInt(Tools.regFind(html, "<span class=\"user-black\" style=\"margin-left: 12px;\">Memory Limit:&nbsp;(\\d+?)[\\s]+?KiB</span>")));
        ...
        info.hint = (Tools.regFind(html, "<h4>Hint</h4>([\\s\\S]*?)<h2>Source</h2>"));
        
        info.source = (Tools.regFind(html, "<h4>Source</h4>[\\s\\S]*?<div class=\"prob-content\">([.\\s\\S]+?)</div>"));
    }
